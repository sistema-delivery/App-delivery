        ...
        .then(data => {
          ...
          if (transactionData && transactionData.qr_code_base64 && transactionData.qr_code) {
            ...
            pixInfoDiv.innerHTML = `
              ...
              <img src="data:image/png;base64,${transactionData.qr_code_base64}" alt="QR Code Pix" style="max-width:200px; display:block; margin:0 auto 1rem;" />
              <textarea id="raw-pix-code" readonly style="width:100%; height:4rem; font-family:monospace; padding:0.5rem; margin-bottom:0.5rem;">${transactionData.qr_code}</textarea>
              <button type="button" id="copy-pix-code" style="padding:0.6rem; width:100%;">Copiar código Pix</button>
            `;
